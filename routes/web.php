...
Route::patch('/kategori_artikel/{id}/edit','KategoriArtikelController@update')->name('kategori_artikel.update');
...
Route::patch('/kategori_berita/{id}/edit','KategoriBeritaController@update')->name('kategori_berita.update');
...
Route::patch('/kategori_galeri/{id}/edit','KategoriGaleriController@update')->name('kategori_galeri.update');
...
Route::patch('/kategori_pengumuman/{id}/edit','KategoriPengumumanController@update')->name('kategori_pengumuman.update');
...
Route::patch('/artikel/{id}/edit','ArtikelController@update')->name('artikel.update');*/
...
Route::patch('/berita/{id}/edit','BeritaController@update')->name('berita.update');*/
...
Route::patch('/galeri/{id}/edit','GaleriController@update')->name('galeri.update');*/
...
Route::patch('/pengumuman/{id}/edit','PengumumanController@update')->name('pengumuman.update');*/
